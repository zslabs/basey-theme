...
function basey_enqueue_scripts() {
	...
	wp_enqueue_script( 'basey-dep', get_template_directory_uri() . '/assets/js/build/dep.min.js', array( 'jquery' ), BASEY_VER, true );
	wp_enqueue_script( 'basey-scripts', get_template_directory_uri() . '/assets/js/build/app.min.js', array( 'jquery' ), BASEY_VER, true );
}
