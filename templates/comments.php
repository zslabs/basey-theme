			...
			<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" data-parsley-validate>
				...
				<?php else : ?>
					<div class="row">
						<div class="medium-4 columns">
							<input type="text" placeholder="<?php _e('Name', 'basey'); if ($req) _e(' (required)', 'basey'); ?>" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" <?php if ($req) echo 'data-parsley-required'; ?>>
						</div>
						<div class="medium-4 columns">
							<input type="email" placeholder="<?php _e('Email', 'basey'); if ($req) _e(' (required)', 'basey'); ?>" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" <?php if ($req) echo 'data-parsley-required'; ?>>
						</div>
						<div class="medium-4 columns">
				...
				<div class="row">
					<div class="small-12 columns">
						<textarea placeholder="<?php _e('Comment', 'basey'); ?>" name="comment" id="comment" class="form-control" data-parsley-required></textarea>
					</div>
				</div>
